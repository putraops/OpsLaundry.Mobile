...
class product {
  ...
  String? product_category_description;
  ...
  product.fromJson(Map<String, dynamic> json) {
    ...
    product_category_description = json['product_category_description'];
...
Map<String, dynamic> _$ObjectToJson(product instance) => <String, dynamic>{
  'id' : instance.id,
  ...
  'product_category_name' : instance.product_category_name,
  'product_category_description' : instance.product_category_description,

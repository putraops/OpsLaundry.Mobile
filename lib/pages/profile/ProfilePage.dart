...
class _ProfilePageState extends State<ProfilePage> {
  ...
  final String fullName = "Putra Ompusunggu";
  @override
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              Text(fullName.toUpperCase(), style: const TextStyle(fontSize: 16, letterSpacing: -0.4, fontWeight: FontWeight.bold,),),
                              const Text("081340002000", style: TextStyle(fontSize: 13),),
                            ],
                          ),
                        ),
                      ],
